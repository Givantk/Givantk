// Tab Screens
import AccountScreen from './0-MainScreens/5-AccountScreen/AccountScreen';
import AddServiceScreen from './0-MainScreens/2-AddServiceScreen/AddServiceScreen';
import FeaturedScreen from './0-MainScreens/1-FeaturedScreen/FeaturedScreen';
import MyServicesScreen from './0-MainScreens/3-MyServicesScreen/MyServicesScreen';

// Other Screens
import AddProposalScreen from './commons/ServiceScreen/AddProposalScreen/AddProposalScreen';
import ChatScreen from './commons/ChatScreen/ChatScreen';
import InviteFriendsScreen from './5-AccountInnerScreens/InviteFriendsScreen/InviteFriendsScreen';
